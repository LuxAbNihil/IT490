...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000131f2b3a0000000062f431da(
...
class phpbbtemplatetwiglexer_00000000131f2b3a0000000062f431da extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5bdf2acb091ba696539166 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5bdf2acb091cf048080073 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5bdf2acb0917e608665335 = array(
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, 'set_environment', array('env' => $env), $this->initializer5bdf2acb091cf048080073);

        return $this->valueHolder5bdf2acb091ba696539166->set_environment($env);
    }
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5bdf2acb091cf048080073);

        return $this->valueHolder5bdf2acb091ba696539166->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5bdf2acb091cf048080073);

        return $this->valueHolder5bdf2acb091ba696539166->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5bdf2acb091cf048080073 = $initializer;
    }
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, '__get', array('name' => $name), $this->initializer5bdf2acb091cf048080073);

        if (isset(self::$publicProperties5bdf2acb0917e608665335[$name])) {
            return $this->valueHolder5bdf2acb091ba696539166->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bdf2acb091ba696539166;
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bdf2acb091cf048080073);
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, '__isset', array('name' => $name), $this->initializer5bdf2acb091cf048080073);
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, '__unset', array('name' => $name), $this->initializer5bdf2acb091cf048080073);
    ...
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, '__clone', array(), $this->initializer5bdf2acb091cf048080073);

        $this->valueHolder5bdf2acb091ba696539166 = clone $this->valueHolder5bdf2acb091ba696539166;
    }

    public function __sleep()
    {
        $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, '__sleep', array(), $this->initializer5bdf2acb091cf048080073);

        return array('valueHolder5bdf2acb091ba696539166');
    }
    ...
    {
        return $this->initializer5bdf2acb091cf048080073;
    }
    ...
    {
        return $this->initializer5bdf2acb091cf048080073 && $this->initializer5bdf2acb091cf048080073->__invoke($this->valueHolder5bdf2acb091ba696539166, $this, 'initializeProxy', array(), $this->initializer5bdf2acb091cf048080073);
    }
    ...
    {
        return null !== $this->valueHolder5bdf2acb091ba696539166;
    }
    ...
    {
        return $this->valueHolder5bdf2acb091ba696539166;
    }
