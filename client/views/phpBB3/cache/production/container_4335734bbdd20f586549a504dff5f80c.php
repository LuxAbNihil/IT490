...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000359e2a9a000000002e879fac(
...
class phpbbtemplatetwiglexer_00000000359e2a9a000000002e879fac extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5bdf352b3cc99107705248 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5bdf352b3ccae721465283 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5bdf352b3cc5c650279750 = array(
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, 'set_environment', array('env' => $env), $this->initializer5bdf352b3ccae721465283);

        return $this->valueHolder5bdf352b3cc99107705248->set_environment($env);
    }
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5bdf352b3ccae721465283);

        return $this->valueHolder5bdf352b3cc99107705248->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5bdf352b3ccae721465283);

        return $this->valueHolder5bdf352b3cc99107705248->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5bdf352b3ccae721465283 = $initializer;
    }
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, '__get', array('name' => $name), $this->initializer5bdf352b3ccae721465283);

        if (isset(self::$publicProperties5bdf352b3cc5c650279750[$name])) {
            return $this->valueHolder5bdf352b3cc99107705248->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bdf352b3cc99107705248;
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bdf352b3ccae721465283);
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, '__isset', array('name' => $name), $this->initializer5bdf352b3ccae721465283);
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, '__unset', array('name' => $name), $this->initializer5bdf352b3ccae721465283);
    ...
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, '__clone', array(), $this->initializer5bdf352b3ccae721465283);

        $this->valueHolder5bdf352b3cc99107705248 = clone $this->valueHolder5bdf352b3cc99107705248;
    }

    public function __sleep()
    {
        $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, '__sleep', array(), $this->initializer5bdf352b3ccae721465283);

        return array('valueHolder5bdf352b3cc99107705248');
    }
    ...
    {
        return $this->initializer5bdf352b3ccae721465283;
    }
    ...
    {
        return $this->initializer5bdf352b3ccae721465283 && $this->initializer5bdf352b3ccae721465283->__invoke($this->valueHolder5bdf352b3cc99107705248, $this, 'initializeProxy', array(), $this->initializer5bdf352b3ccae721465283);
    }
    ...
    {
        return null !== $this->valueHolder5bdf352b3cc99107705248;
    }
    ...
    {
        return $this->valueHolder5bdf352b3cc99107705248;
    }
