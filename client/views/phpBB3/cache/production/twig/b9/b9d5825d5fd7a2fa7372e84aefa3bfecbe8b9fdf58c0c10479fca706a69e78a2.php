...
/* viewforum_body.html */
class __TwigTemplate_da78d78d9b1183972fd50b64fca46e24841bea2bc4442ab82e6ed88b956a3ebc extends Twig_Template
{
...
\t\t\t";
                ...
                $this->loadTemplate("display_options.html", "viewforum_body.html", 274)->display($context);
                if ($namespace) {
                    $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                }
                // line 275
...
\t\t\t";
            ...
            if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "pagination", array()))) {
                ...
                $this->loadTemplate("pagination.html", "viewforum_body.html", 282)->display($context);
                if ($namespace) {
                    $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                }
                // line 283
...
";
        ...
        $this->loadTemplate("jumpbox.html", "viewforum_body.html", 290)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
        // line 291
...
";
        ...
        $this->loadTemplate("overall_footer.html", "viewforum_body.html", 306)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
